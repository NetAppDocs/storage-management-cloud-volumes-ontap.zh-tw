...
+
此選項僅適用於某些虛擬機器類型。若要了解支援哪些虛擬機器類型，請參閱 link:link:reference-configs-azure.html#ha-pairs["HA 對許可證支援的配置"]。
...
+
link:link:reference-configs-azure.html#ha-pairs["詳細了解 Azure 中支援的配置"^]。
