...
----
https://docs.netapp.com/us-en/console-setup-admin/reference-permissions-azure.html["查看最新的權限列表"^]

.步驟
. 使用下列 API 呼叫取得 Azure 訂閱中的金鑰保管庫清單。
+
https://docs.netapp.com/us-en/console-automation/cvo/get-azure-ha-metadata-keys-vault.html["對於 HA 配對"^]: `GET /azure/ha/metadata/vaults`

+
https://docs.netapp.com/us-en/console-automation/cvo/get-azure-vsa-metadata-keys-vault.html["對於單一節點"^]: `GET /azure/vsa/metadata/vaults`
...
+
對於 HA 配對： `GET /azure/ha/metadata/keys-vault?resourceGroupName=KeyVaultResourceGroup&vaultName=KeyVault`

+
對於單一節點： `GET /azure/vsa/metadata/keys-vault?resourceGroupName=KeyVaultResourceGroup&vaultName=KeyVault`
...
+
.. 對於 HA 配對，請使用 https://docs.netapp.com/us-en/console-automation/cvo/post-azure-ha-working-environments.html["此 API 呼叫"^]：
+
...
.. 對於單節點系統，請使用  https://docs.netapp.com/us-en/console-automation/cvo/post-azure-vsa-working-environments.html["此 API 呼叫"^]：
+
...
.相關連結
* https://docs.netapp.com/us-en/console-automation/cm/wf_cvo_before.html["準備使用 Cloud Volumes ONTAP API 工作流程"^]。
* https://docs.netapp.com/us-en/console-automation/cm/api_ref_resources.html#azure-haworking-environments["了解 ONTAP 管理 REST API"^]。
