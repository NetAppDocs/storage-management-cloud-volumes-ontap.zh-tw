...
+
從NetApp控制台建立磁碟區時跳過選擇儲存效率設置，或建立磁碟區然後 http://docs.netapp.com/ontap-9/topic/com.netapp.doc.dot-cm-vsmg/GUID-8508A4CB-DB43-4D0D-97EB-859F58B29054.html["使用 CLI 停用資料壓縮"^]。
