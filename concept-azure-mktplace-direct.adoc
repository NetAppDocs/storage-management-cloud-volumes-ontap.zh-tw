...
[role="lead"]
NetApp提供了兩種在 Azure 上部署Cloud Volumes ONTAP 的選項。 Cloud Volumes ONTAP傳統上依賴NetApp控制台進行部署和編排。從Cloud Volumes ONTAP 9.16.1 開始，您可以利用 Azure 市場直接部署，這是一個簡化的過程，可以存取有限但仍然強大的Cloud Volumes ONTAP功能和選項。
...
| *編排功能* | 無法使用 | 根據許可證類型，可透過NetApp控制台取得 
...
* https://docs.netapp.com/us-en/bluexp-family/index.html["NetApp控制台文檔"^]
