...
| *支援的虛擬機器 (VM) 類型*  a| 
Eds_v5 和 Ls_v3 實例類型
| 涵蓋所有虛擬機器類型。link:reference-configs-azure.html["Azure 中支援的配置"] 
...
| *支援的磁碟類型* | 高級 SSD v2 託管磁碟 | 更廣泛的支援。link:reference-configs-azure.html#azure-storage-for-user-data["Azure 中支援的磁碟類型"] 
...
* link:https://docs.netapp.com/us-en/console-family/index.html["NetApp Console文檔"^]
