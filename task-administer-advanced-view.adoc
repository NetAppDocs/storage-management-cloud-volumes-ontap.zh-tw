...
.步驟
. 從左側導覽窗格前往*管理>代理*。
. 按一下所需主控台代理程式的 image:icon-action.png["一個顯示三個水平點的圖示，用於執行其他動作"] 圖示，然後選取 *編輯主控台代理程式*。
...
* https://docs.netapp.com/us-en/ontap/concepts/introducing-ontap-interfaces-concept.html["ONTAP 使用者介面"^]
* https://docs.netapp.com/us-en/ontap/concept_administration_overview.html["使用 ONTAP System Manager 了解叢集管理"^]
