...
* 建立 iSCSI Volume 時，控制台會自動為您建立一個 LUN。我們簡化了操作，每個 Volume 只建立一個 LUN，因此無需任何管理。建立 Volume 之後，link:https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-connect-lun.html["使用 IQN 從主機連線到 LUN"^]。
...
.特定骨材
--
.. 在 *彙總* 標籤上，前往所需的彙總，然後按一下 image:icon-action.png["一個顯示三個水平點的圖示，用於執行其他動作"] 圖示。
...
NTP 伺服器:: 選擇 *Use Active Directory Domain* 以使用 Active Directory DNS 設定 NTP 伺服器。如果您需要使用其他位址設定 NTP 伺服器，則應使用 API。如需詳細資訊，請參閱 https://docs.netapp.com/us-en/console-automation/index.html["NetApp Console 自動化文件"^]。
+
--
...
+
*** link:https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-planning-your-config.html#size-your-system-in-aws["在 AWS 中調整系統規模"^]
...
* link:https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-planning-your-config-azure.html#size-your-system-in-azure["在 Azure 中調整系統大小"^]
...
* link:https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-planning-your-config-gcp.html#size-your-system-in-gcp["在 Google Cloud 中調整系統規模"^]
