...
* 如果您擁有 BYOL 授權並透過市集簽訂了年度合約，您的使用量和超額使用量將根據您設定的計費偏好收取費用。若要了解您的收費方式，請參閱 link:concept-licensing-charging.html#concept-licensing-charging.html#billing-preferences-and-overages["計費偏好和超額費用"]。
