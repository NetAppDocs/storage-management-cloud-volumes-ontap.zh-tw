...
. 從NetApp Console選單中，選擇「管理 >Licenses and subscriptions」。
. 選擇* Keystone訂閱*。
. 對於要關聯的訂閱，請選擇 image:icon-action.png["三個並排的點組成的圖標"] 並選擇 *Link* 。
...
. 從NetApp Console選單中，選擇「管理 >Licenses and subscriptions」。
. 選擇* Keystone訂閱*。
. 對於要調整容量的訂閱，請選擇 image:icon-action.png["三個並排的點組成的圖標"] 並選擇 *View detail and edit* 。
. 輸入一個或多個訂閱所請求的承諾容量。
. 向下捲動，輸入請求的任何其他詳細資訊，然後選擇 *Submit* 。
...
. 從NetApp Console選單中，選擇「管理 >Licenses and subscriptions」。
. 選擇* Keystone*。
. 對於您要取消連結的訂閱，請選取 image:icon-action.png["三個並排的點組成的圖標"] 並選取 *Unlink*。
