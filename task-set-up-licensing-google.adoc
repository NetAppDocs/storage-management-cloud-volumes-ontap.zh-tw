...
.步驟
. 從左側導覽功能表中，選擇“儲存”>“管理”。
. 在「*系統*」頁面上，按一下「*新增系統*」並依照NetApp控制台中的步驟進行操作。
+
...
. https://docs.netapp.com/us-en/bluexp-setup-admin/task-adding-nss-accounts.html#add-an-nss-account["將您的NetApp支援網站帳號新增至NetApp控制台"^]
+
