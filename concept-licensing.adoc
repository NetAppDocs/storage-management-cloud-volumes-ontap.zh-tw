...
BYOL 授權可向 NetApp 購買，並可用於任何雲端供應商。有關 BYOL 授權可用度的詳細資訊，請參閱 https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/whats-new.html#restricted-availability-of-byol-licensing-for-cloud-volumes-ontap["Cloud Volumes ONTAP的 BYOL 授權可用性受限"^]。
...
* link:link:reference-configs-azure.html["Azure 中支援的配置"]
...
* link:link:reference-configs-gcp.html["Google Cloud 中支援的配置"^]
