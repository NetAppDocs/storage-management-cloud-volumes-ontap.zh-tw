...
.步驟
. 如果您在系統上啟用了備份和還原功能，請確定是否仍然需要備份的數據，然後… https://docs.netapp.com/us-en/data-services-backup-recovery/prev-ontap-backup-manage.html#delete-backups["如有必要，刪除備份"^] 。
+
...
+
https://docs.netapp.com/us-en/data-services-data-classification/concept-cloud-compliance.html#the-cloud-data-sense-instance["了解有關資料分類實例的更多信息"^]。

. 刪除Cloud Volumes ONTAP系統。
+
.. 在「*系統*」頁面上，雙擊要刪除的Cloud Volumes ONTAP系統的名稱。
.. 在主控台的右上角，按一下 image:icon-action.png["一個顯示三個水平點的圖示，用於執行其他動作"] 圖示，然後選取 *刪除*。
