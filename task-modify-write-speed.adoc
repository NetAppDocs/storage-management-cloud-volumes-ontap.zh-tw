...
---
= 在 Cloud Volumes ONTAP 中修改系統寫入速度
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
所有類型的單節點系統和部分 HA 配對配置均支援高寫入速度。在 https://docs.netapp.com/us-en/cloud-volumes-ontap-relnotes/["Cloud Volumes ONTAP發行說明"^]中查看支援的配置
