...
---
= 了解 Cloud Volumes ONTAP 節點型 BYOL
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
link:concept-licensing.html["了解Cloud Volumes ONTAP許可證"]。

link:https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-manage-node-licenses.html["了解有關如何管理基於節點的許可證的更多信息"^]。
...
https://docs.netapp.com/us-en/console-setup-admin/task-adding-nss-accounts.html["了解如何將NetApp支援網站帳戶新增至控制台"^]。
