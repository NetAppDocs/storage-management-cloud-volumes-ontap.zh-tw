...
這些權限包含在 https://docs.netapp.com/us-en/console-setup-admin/reference-permissions-aws.html["NetApp提供的政策"^]
...
+
https://docs.netapp.com/us-en/data-services-replication/task-replicating-data.html["了解如何設定資料複製"^]
