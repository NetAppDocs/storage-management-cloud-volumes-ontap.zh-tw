...
* 如果您尚未在主控台中註冊 NSS 帳戶，請立即註冊 NSS 帳戶，然後 Digital Advisor UI 就會出現。請參閱 https://docs.netapp.com/us-en/console-setup-admin/task-adding-nss-accounts.html["管理與組織或帳戶關聯的 NSS 憑證"]以取得指示。
