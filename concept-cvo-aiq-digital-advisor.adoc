...
[role="lead"]
https://www.netapp.com/data-services/digital-advisor/["NetApp Active IQ Digital Advisor"^]（也稱為 Digital Advisor）已整合至 NetApp Console，讓您可以在單一窗格中最佳化 Cloud Volumes ONTAP 系統的作業、安全性和效能。
