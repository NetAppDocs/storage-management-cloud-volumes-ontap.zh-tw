...
----
+
URL 遵循標準格式。為了實現自動化，您可以如下所示匯出 URL 字串。或者，您可以使用 Azure CLI `az` 命令來取得 URL。範例 URL：+https://examplesaname.bluexpinfraprod.eastus2.data.azurecr.io/vm-images/9150.01000024.05090105.vhd+
