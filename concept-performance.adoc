...
+
link:https://www.netapp.com/pdf.html?item=/media/9088-tr4383.pdf["NetApp技術報告 4383：Amazon Web Services 中Cloud Volumes ONTAP與應用程式工作負載的效能特徵"^]
...
+
link:https://www.netapp.com/pdf.html?item=/media/9089-tr-4671.pdf["NetApp技術報告 4671：Azure 中Cloud Volumes ONTAP與應用程式工作負載的效能特徵"^]
