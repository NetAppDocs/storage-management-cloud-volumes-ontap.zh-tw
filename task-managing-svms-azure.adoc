...
如需執行 Cloud Volumes ONTAP API 呼叫的相關資訊，請參閱 https://docs.netapp.com/us-en/console-automation/cm/your_api_call.html#step-1-select-the-identifie["您的第一次 API 呼叫"^]。
...
.開始之前
控制台代理程式需要特定權限才能為 Cloud Volumes ONTAP 建立儲存設備虛擬機器。所需的權限包含在 https://docs.netapp.com/us-en/console-setup-admin/reference-permissions-azure.html["NetApp提供的政策"^]。
...
.開始之前
控制台代理程式需要特定權限才能管理 Cloud Volumes ONTAP 的儲存設備虛擬機器。所需的權限包含在 https://docs.netapp.com/us-en/console-setup-admin/reference-permissions-azure.html["NetApp提供的政策"^]中。
...
* https://docs.netapp.com/us-en/console-automation/platform/use_rest_apis.html["使用NetApp Console的 REST API"^]
