...
除了透過 https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-protecting-ransomware.html#protection-from-common-ransomware-file-extensions["勒索軟體防護設置"]提供的檔案副檔名保護之外，ARP 功能使用工作負載分析，根據偵測到的「異常活動」向使用者發出潛力攻擊的警報。勒索軟體保護設定和 ARP 功能可以結合使用，以實現全面的勒索軟體保護。
